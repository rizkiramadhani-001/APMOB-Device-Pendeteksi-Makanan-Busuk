...
export default function DeviceManager({ devices, connectToNewDevice, connectToSavedDevice, disconnectDevice, removeDeviceUi, renameDevice }) {
  ...
  return (
    <section className="mb-6 p-6 rounded-[28px] bg-white/70 dark:bg-black/40 border border-slate-200/50 dark:border-white/10 shadow-sm backdrop-blur-xl relative overflow-hidden transition-all duration-300 select-none">
      ...
      <div className="flex items-center justify-between gap-3 mb-5 relative z-10">
        ...
        <button
          ...
          className="glow-btn bg-gradient-to-r from-cyan-500 to-indigo-600 hover:from-cyan-600 hover:to-indigo-700 text-white text-[10px] font-black py-2 px-3.5 rounded-full flex items-center justify-center gap-1.5 shrink-0"
        >
